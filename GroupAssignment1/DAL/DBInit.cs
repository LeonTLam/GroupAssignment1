...
public static class DBInit
{
    public static void Seed(IApplicationBuilder app)
    {
        ...
        if (!context.Orders.Any())
        {
            ...
            {
                new Order {StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(12),  HousingId = 1},
                new Order {StartDate = DateTime.Today, EndDate = DateTime.Today.AddDays(14),  HousingId = 2},
            };
